...
const x402_service_1 = require("./x402/providers/x402.service");
const swagger_1 = require("@nestjs/swagger");
let AppController = class AppController {
    constructor(appService, x402Service) {
...
], AppController.prototype, "getHelloPremium", null);
