...
export class X402Service {
    ...
    async verifyPayment(req: any, res: any, config: PaywallConfig): Promise<boolean> {
        const FACILITATOR_URL =
            process.env.FACILITATOR_URL || "https://facilitator.payai.network";
        const WALLET_ADDRESS =
            process.env.WALLET_ADDRESS || "CEBAqJoQXomRdMubgTWL1fa99d2zr2rFTMPukk62fSUw";
    ...
    async transferUSDC(
        ...
        try {
            const rpcURL = this.NETWORK === "solana-devnet" ? "https://api.devnet.solana.com" : "https://api.mainnet-beta.solana.com";
